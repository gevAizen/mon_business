    ...
    >
      ...
      >
        <div className="flex flex-col items-start">
          ...
          {entries.length > 0 && (
            <div className="w-full flex items-center justify-between gap-6 text-5xl font-bold mt-2">
        ...
        <>
          ...
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-200 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Après 7 jours d’utilisation, vous pourrez suivre l’évolution de
                votre business.
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          {entries.length === 0 && (
            <p className="text-xs text-gray-500 mt-2 mb-6">
              Une entrée peut être une vente, une dépense ou un achat de stock.
